...
const genreLinks = [
  { title: "Acción", href: "/genre/28" },
  { title: "Comedia", href: "/genre/35" },
  { title: "Drama", href: "/genre/18" },
  { title: "Terror", href: "/genre/27" },
  { title: "Ciencia Ficción", href: "/genre/878" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-10">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your ultimate destination to discover the latest movies,
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Subscribe for updates on new releases, exclusive content, and
              special offers.
            </p>
