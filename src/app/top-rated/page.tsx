...
import { Film, Sparkles, Star, Award } from "lucide-react";
...
export const metadata = {
  title: "Top Rated Movies - Movie Studio",
          ...
          <div className="container mx-auto px-4 md:px-6 pb-12 md:pb-16">
            <div className="max-w-4xl space-y-4">
              ...
              <p className="text-base md:text-lg lg:text-xl text-white/90 drop-shadow-lg max-w-2xl">
                Discover the highest rated movies of all time. These critically
                acclaimed masterpieces have earned their place in cinema
                history.
              </p>
