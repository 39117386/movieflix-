...
export const metadata = {
  title: "Upcoming Movies - Movie Studio",
  description: "Coming soon to theaters near you",
};

export default async function UpcomingPage() {
  const movies = (await getUpcomingMovies(1)) || [];
          ...
          <div className="container mx-auto px-4 md:px-6 pb-12 md:pb-16">
            <div className="max-w-4xl space-y-4">
              ...
              <p className="text-base md:text-lg lg:text-xl text-white/90 drop-shadow-lg max-w-2xl">
                Get ready for the most anticipated releases coming soon to
                theaters. Mark your calendar for these exciting new films.
              </p>
