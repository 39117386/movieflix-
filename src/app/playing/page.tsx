...
export const metadata = {
  title: "Ahora en Cartelera - Sociopedia Movies",
  description: "Películas actualmente en cines",
};
          ...
          <div className="container mx-auto px-4 md:px-6 pb-12 md:pb-16">
            <div className="max-w-4xl space-y-4">
              ...
              <p className="text-base md:text-lg lg:text-xl text-white/90 drop-shadow-lg max-w-2xl">
                Descubre las películas más atractivas que se muestran actualmente en los cines.
                Experimenta los últimos éxitos de taquilla y películas aclamadas por la crítica.
              </p>
