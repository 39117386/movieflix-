...
export const metadata: Metadata = {
  title: "Política de Privacidad - Sociopedia Movies",
  description:
      ...
      <section className="relative h-[40vh] md:h-[50vh] flex items-center justify-center bg-linear-to-b from-primary/20 to-background">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Tu privacidad es importante para nosotros. Aprende cómo protegemos tus datos.
          </p>
        </div>
      </section>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Sociopedia Movies ("nosotros", "nuestro", o "nos") está comprometida con la
                  protección de tu privacidad. Esta Política de Privacidad explica cómo
