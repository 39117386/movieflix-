...
export const metadata: Metadata = {
  title: "Términos y Condiciones - Sociopedia Movies",
  description:
    "Lee nuestros términos y condiciones para usar los servicios de Sociopedia Movies.",
};
      ...
      <section className="relative h-[40vh] md:h-[50vh] flex items-center justify-center bg-linear-to-b from-primary/20 to-background">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Por favor lee estos términos y condiciones cuidadosamente antes de usar nuestro
            servicio
          </p>
        </div>
      </section>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Bienvenido a Sociopedia Movies. Estos Términos y Condiciones
                  rigen tu uso de nuestro sitio web y servicios. Al acceder o
